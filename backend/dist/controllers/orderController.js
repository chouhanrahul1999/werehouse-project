...
const seedOrders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.json({ message: "Mock orders seeded", count: inserted.length });
        // Automatically start syncing after 2 seconds
        setTimeout(() => {
            // Call syncOrders with mock req/res (no real HTTP response needed)
        ...
        res.status(500).json({ message: "Failed to seed orders", error });
    }
});
